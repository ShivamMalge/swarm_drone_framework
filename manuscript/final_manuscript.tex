...
% WARNING: every number in this table is stale. The rows were produced before the
% metric corrections and the oracle row still carries figures measured from the
% "static_bounded" arm, which is NOT the oracle (it is bit-identical to the
% Proposed arm). Regenerate from run_monte_carlo_table.py after Phase 1.1/1.2/1.3
% and paste the runner output into fixes_phases.md before this table is trusted.
% =================================================================================
\begin{table}[htbp]
...
Centralized Oracle (global info, all-to-all comm. cost) & $0.29 \pm 0.01$ & $0.05 \pm 0.00$ & $1999 \pm 2$ \\
